...
const MESSAGES = {
  en: {
    ...
    'pages.empty': 'Content coming soon.',
    'pages.failed': 'Couldn’t load this page.',
    'pages.updated': 'Last updated',
    ...
    'profile.emailNote': 'Email can’t be changed.',
    ...
    'profile.pwdMismatch': 'Passwords don’t match',
    'profile.pwdShort': 'New password must be at least 8 characters',
  ...
  ar: {
    ...
    'account.store': 'المتجر',

    'pages.about': 'من نحن',
    'pages.terms': 'الشروط والأحكام',
    'pages.privacy': 'سياسة الخصوصية',
    'pages.contact': 'تواصل معنا',
    'pages.empty': 'المحتوى قيد الإعداد.',
    'pages.failed': 'تعذّر تحميل الصفحة.',
    'pages.updated': 'آخر تحديث',
    ...
    'profile.pwdShort': 'يجب أن تكون كلمة المرور 8 أحرف على الأقل',
    'profile.nameRequired': 'الاسم الأول واسم العائلة مطلوبان',
